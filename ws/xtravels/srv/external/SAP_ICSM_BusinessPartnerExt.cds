/* checksum : e5490d12b47562547b15111cd4a019cb */
@cds.external : true
@m.IsDefaultEntityContainer : 'true'
@sap.message.scope.supported : 'true'
@sap.supported.formats : 'atom json xlsx'
service SAP_ICSM_BusinessPartnerExt {
  @cds.external : true
  ...
  entity A_BusinessPartner {
    ...
    TradingPartner : String(6);
    @sap.display.format : 'UpperCase'
    @sap.label : '(Obsolete)Study'
    @sap.quickinfo : 'Study'
    xctcoxstudy_id : String(10);
    @sap.label : '(Obsolete)Protocol ID'
    @sap.quickinfo : 'Protocol ID'
    xctcoxprotocol_id : String(30);
    @sap.label : '(Obsolete)Site ID'
    @sap.quickinfo : 'Site ID'
    xctcoxsite_id : String(20);
    @sap.display.format : 'UpperCase'
    @sap.label : '(Obsolete)Site Status'
    @sap.quickinfo : 'Site Status'
    xctcoxsite_status : String(2);
    @sap.display.format : 'UpperCase'
    @sap.label : 'Calendar ID'
    @sap.quickinfo : 'Factory Calendar'
    xctcoxcalendar : String(2);
    @sap.label : '(Obsolete)Site Group ID'
    @sap.quickinfo : 'Site Group ID'
    @sap.creatable : 'false'
    @sap.updatable : 'false'
    xctcoxsite_group_id : String(10);
    ...
    ICSMToStudyItem : Association to many ICSMStudyItem {  };
  };
  ...
  @sap.content.version : '1'
  @sap.label : 'Study Information'
  entity ICSMStudyItem {
    @sap.label : 'External BP Number'
    @sap.creatable : 'false'
    @sap.updatable : 'false'
    @sap.sortable : 'false'
    @sap.filterable : 'false'
    key BusinessPartnerIDByExtSystem : String(20) not null;
    @sap.label : 'Protocol ID'
    @sap.creatable : 'false'
    @sap.updatable : 'false'
    @sap.sortable : 'false'
    @sap.filterable : 'false'
    key ProtocolID : String(30) not null;
    @sap.label : 'Site ID'
    @sap.creatable : 'false'
    @sap.updatable : 'false'
    @sap.sortable : 'false'
    @sap.filterable : 'false'
    key SiteID : String(20) not null;
    @sap.label : 'Business Partner'
    @sap.creatable : 'false'
    @sap.updatable : 'false'
    @sap.sortable : 'false'
    ...
    @sap.sortable : 'false'
    @sap.filterable : 'false'
    StudyId : String(10) not null;
    @sap.label : 'Site Status'
    @sap.creatable : 'false'
    @sap.updatable : 'false'
    @sap.sortable : 'false'
    @sap.filterable : 'false'
    SiteStatus : String(2) not null;
    @sap.label : 'Site Group ID'
    @sap.creatable : 'false'
    @sap.updatable : 'false'
    @sap.sortable : 'false'
    @sap.filterable : 'false'
    SiteGroupID : String(10) not null;
    @sap.label : 'Contact 1 Title'
    @sap.creatable : 'false'
    @sap.updatable : 'false'
    @sap.sortable : 'false'
    @sap.filterable : 'false'
    ContactPerson1Title : String(128) not null;
    @sap.label : 'Contact 1 First Name'
    @sap.creatable : 'false'
    @sap.updatable : 'false'
    @sap.sortable : 'false'
    @sap.filterable : 'false'
    ContactPerson1FirstName : String(128) not null;
    @sap.label : 'Contact 1 Last Name'
    @sap.creatable : 'false'
    @sap.updatable : 'false'
    @sap.sortable : 'false'
    @sap.filterable : 'false'
    ContactPerson1LastName : String(128) not null;
    @sap.label : 'Contact 2 Title'
    @sap.creatable : 'false'
    @sap.updatable : 'false'
    @sap.sortable : 'false'
    @sap.filterable : 'false'
    ContactPerson2Title : String(128) not null;
    @sap.label : 'Contact 2 First Name'
    @sap.creatable : 'false'
    @sap.updatable : 'false'
    @sap.sortable : 'false'
    @sap.filterable : 'false'
    ContactPerson2FirstName : String(128) not null;
    @sap.label : 'Contact 2 Last Name'
    @sap.creatable : 'false'
    @sap.updatable : 'false'
    @sap.sortable : 'false'
    @sap.filterable : 'false'
    ContactPerson2LastName : String(128) not null;
    @sap.label : 'Purpose Code'
    @sap.creatable : 'false'
    @sap.updatable : 'false'
    @sap.sortable : 'false'
    @sap.filterable : 'false'
    PurposeCode : String(10) not null;
  };
};
